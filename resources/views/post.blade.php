...
<body style="font-family: Open Sans, sans-serif">
    <section class="px-6 py-8">
        ...
        <main class="max-w-6xl mx-auto mt-10 lg:mt-20 space-y-6 flex flex-col">
            <h1 class="text-xl font-bold self-center">{{$post->title}} <span class="text-sm font-medium">By <a href="/authors/{{$post->author->username}}" class="text-blue-600 underline"> {{$post->author->name}}</a></span></h1>
