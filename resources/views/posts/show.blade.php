                    ...
                    @auth
                        <x-panel>
                            <form action="/posts/{{$post->slug}}/comments" method="POST">
                                ...
                                <div class="mt-6">
                                    <textarea name="body" class="w-full text-sm focus:outline-none focus:ring p-2" rows="5" placeholder="Quick, think of something to say"></textarea>
                                </div>

                                <div class="flex justify-start mt-6 pt-6 border-t border-gray-200 pt-6">
                                    <button type="submit" class="bg-blue-500 text-white uppercase font-semibold text-xs py-2 px-10 rounded-2xl hover:bg-blue-600 focus:bg-blue-600">Post</button>
                                </div>
                            </form>
                        </x-panel>
                    @else
