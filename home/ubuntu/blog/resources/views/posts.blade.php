...
<body style="font-family: Open Sans, sans-serif">
    <section class="px-6 py-8">
        ...
        <!-- As the $posts variable is an array of 3 it renders the below three times - later dynamically choose this to show the content of each post -->
        <main class="max-w-6xl mx-auto mt-6 lg:mt-20 space-y-6">
            <?php foreach($posts as $post) : ?>
                <article>
                    <h1><?=$post->title;?></h1>
                    <p><?=$post->excerpt;?></p>
                    <a href="/basic-posts/<?= $post->slug; ?>">Read More </a>
                </article>
                <?php endforeach; ?>
                ...
                <div class="py-6 px-5 lg:flex">
                    ...
                    <div class="flex-1 flex flex-col justify-between">
                        ...
                        <footer class="flex justify-between items-center mt-8">
                            ...
                            <div>
                                <a href="/posts/my-first-post" class="transition-colors duration-300 text-xs font-semibold bg-gray-200 hover:bg-gray-300 rounded-full py-2 px-8">
                                    Read More
                                </a>
                            </div>
                        </footer>
